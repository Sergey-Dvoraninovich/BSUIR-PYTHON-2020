        ...
        if json_string[i] == '"':
            ...
            if isConst(json_string, i):
                ...
                while True:
                    ...
                    while ((symbol != ',' and b >= 1) and (not (b == 0))) or keep_going:
                        #print(current_s)
                        if symbol == '[':
                            b += 1
                        if json_string[i] == ']':
...
#dict_info = from_json(' "abc" : { "d" : null, "ans" : [ "s1" : 1, "s2" : 2] }, "b" : true, , "k" : false ')
#a = make_class('MyClass', dict_info)
#print(a.b, "  ", a.abc.d)
#dict_info = from_json(' "abc" : "fdk" ')
#a = make_class('MyClass', dict_info)
#print(a.abc)

#dict_info = from_json(' "abc" : [ "a" : 12, "list" : ["b" : 4], "c" : { "num" : 12}] ')
#a = make_class('MyClass', dict_info)
#d = a.abc[1]
#d = d["list"]
#d = d[0]
